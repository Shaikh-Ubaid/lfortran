...
public:
    ...
    void fix_type_info(T* x) {
        ...
        std::map<ASR::asr_t*, DependenciesVec> node2deps;
        for( TypeMissingData* data: type_info ) {
            ...
            if( sym && ASR::is_a<ASR::Variable_t>(*sym) ) {
                ...
                DependenciesVec variable_dependencies_vec;
    ...
    void visit_Subroutine(const AST::Subroutine_t &x) {
        in_Subroutine = true;
        DependenciesVec current_function_dependencies_copy = current_function_dependencies;
        current_function_dependencies.clear(al);
    ...
    void visit_DerivedType(const AST::DerivedType_t &x) {
        ...
        DependenciesVec struct_dependencies;
