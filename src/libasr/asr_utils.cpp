...
void process_overloaded_assignment_function(ASR::symbol_t* proc, ASR::expr_t* target, ASR::expr_t* value,
    ...
    const Location& value_loc, SymbolTable* curr_scope, DependenciesVec& current_function_dependencies,
    DependenciesVec& current_module_dependencies, ASR::asr_t*& asr, ASR::symbol_t* sym, const Location& loc, ASR::expr_t* expr_dt,
