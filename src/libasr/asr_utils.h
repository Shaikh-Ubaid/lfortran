...
bool use_overloaded(ASR::expr_t* left, ASR::expr_t* right,
                    ...
                    DependenciesVec& current_function_dependencies,
                    DependenciesVec& current_module_dependencies,
                    const std::function<void (const std::string &, const Location &)> err);
...
static inline void insert_module_dependency(ASR::symbol_t* a,
    Allocator& al, DependenciesVec& module_dependencies) {
...
class ReplaceArgVisitor: public ASR::BaseExprReplacer<ReplaceArgVisitor> {
    ...
    ReplaceArgVisitor(Allocator& al_, SymbolTable* current_scope_,
                      ...
                      DependenciesVec& current_function_dependencies_) :
...
class CollectIdentifiersFromASRExpression: public ASR::BaseWalkVisitor<CollectIdentifiersFromASRExpression> {
    private:
        ...
        Allocator& al;
        DependenciesVec& identifiers;

    public:

        CollectIdentifiersFromASRExpression(Allocator& al_, DependenciesVec& identifiers_) :
...
static inline void collect_variable_dependencies(Allocator& al, DependenciesVec& deps_vec,
